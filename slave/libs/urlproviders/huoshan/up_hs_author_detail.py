...
class HuoshanAuthorDetailUrlProvider(urlprovider.UrlProvider):
    """
        classdocs
    """
    url = "http://hotsoon.snssdk.com/hotsoon/user/{user_id}/?live_sdk_version=272&iid={iid}&device_id={device_id}&ac=wifi&channel=goapk&aid=1112&app_name=live_stream&version_code=272&version_name=2.7.2&device_platform=android&ssmix=a&device_type=H60-L02&device_brand=Huawei&os_api=19&os_version=4.4.2&uuid={uuid}&openudid={openudid}&manifest_version_code=272&resolution=1080*1776&dpi=480&update_version_code=2722"
    ...
    def next(self):
        ...
        log.debug("HuoshanAuthorDetailUrlProvider next: {}".format(urlPack))
        return urlPack
